package com.link.notesapp.database;
...
import com.link.notesapp.dao.NoteDao;
import com.link.notesapp.dao.NoteDao_Impl;
...
>>>>>>> Stashed changes
        ...
        if (! _infoNotes.equals(_existingNotes)) {
          return new RoomOpenHelper.ValidationResult(false, "notes(com.link.notesapp.entities.Note).\n"
                  + " Expected:\n" + _infoNotes + "\n"
                  + " Found:\n" + _existingNotes);
        }
